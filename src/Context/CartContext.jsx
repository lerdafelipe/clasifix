...
export function CartProvider({ defaultValue = [], children }) {
  ...
  return (
    <CartContext.Provider value={{
      CartItems, addItem, removeItem, clearCart, totalProduct, total, cartNumber, idCompra, newIdCompra,
    }}
    >
      {children}
